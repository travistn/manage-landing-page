...
const Home = () => {
  ...
  return (
    <div className='w-[90%] m-auto lg:w-[80%]'>
      <Navbar />
      <div className='w-full flex flex-col gap-16 items-center mt-16 lg:gap-[8rem] lg:mt-[6rem]'>
        <div className='bg-pattern absolute bg-no-repeat bg-center' />
        ...
        <section className='w-screen h-[405px] flex flex-col justify-center items-center gap-8 bg-bright-red bg-cta-mobile bg-no-repeat bg-left lg:bg-cta-desktop lg:h-[220px] lg:flex-row lg:bg-center'>
